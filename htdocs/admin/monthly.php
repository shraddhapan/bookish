...
<table>
	...
	<td><?php echo $s; ?></td>
	<td><?php echo $cust ;?></td>
	<td><?php $result=mysqli_query($db,"SELECT sum(amount) as sum1 from orders where customerid=$cust and date > DATE_SUB(NOW(), INTERVAL 1 MONTH)") ; $row=mysqli_fetch_array($result); echo $row{'sum1'};?></td>
	<td><?php 
